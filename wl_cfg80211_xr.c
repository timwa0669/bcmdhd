...
/* add_key */
s32
wl_cfg80211_add_key_xr(dhd_pub_t *src_pub, dhd_pub_t *dest_pub, struct wiphy *wiphy, struct net_device *dev,
...
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 2) || DHD_ANDROID_CFG80211_BACKPORT_V1 */
			if (chandef->chan) {
