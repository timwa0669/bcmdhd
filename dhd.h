...
typedef enum dhd_attach_states
{
	...
	DHD_ATTACH_STATE_NET_ALLOC =		(1<<0),
	DHD_ATTACH_STATE_DHD_ALLOC =		(1<<1),
	DHD_ATTACH_STATE_ADD_IF =		(1<<2),
	DHD_ATTACH_STATE_PROT_ATTACH =		(1<<3),
	DHD_ATTACH_STATE_WL_ATTACH =		(1<<4),
	DHD_ATTACH_STATE_THREADS_CREATED =	(1<<5),
	DHD_ATTACH_STATE_WAKELOCKS_INIT =	(1<<6),
	DHD_ATTACH_STATE_CFG80211 =		(1<<7),
	DHD_ATTACH_STATE_EARLYSUSPEND_DONE =	(1<<8),
	DHD_ATTACH_TIMESYNC_ATTACH_DONE =	(1<<9),
	DHD_ATTACH_LOGTRACE_INIT =		(1<<10),
	DHD_ATTACH_STATE_LB_ATTACH_DONE =	(1<<11),
	DHD_ATTACH_STATE_HANG_INIT_DONE =	(1<<12),
	DHD_ATTACH_STATE_DONE =			(1<<13)
} dhd_attach_states_t;
