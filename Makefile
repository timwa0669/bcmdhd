...
CONFIG_BCM4356 :=
CONFIG_BCM4339 :=
#DHDCFLAGS += -DCONFIG_BCM4359
#DHDCFLAGS += -DCONFIG_BCM4361
#DHDCFLAGS += -DCONFIG_BCM4375
#DHDCFLAGS += -DCONFIG_BCM43012
#DHDCFLAGS += -DCONFIG_CYW89570
#CONFIG_BCMDHD_43022 := y
...
#DHDCFLAGS += -DCONFIG_BCMDHD_FW_PATH=\"\"
#DHDCFLAGS += -DCONFIG_BCMDHD_NVRAM_PATH=\"\"
#DHDCFLAGS += -DCONFIG_BCMDHD_CLM_PATH=\"\"
#DHDCFLAGS += -DCONFIG_BCMDHD_BTFW_PATH=\"\"

# Platform specific.
#CONFIG_DHD_OF_SUPPORT = y
#CONFIG_BCMDHD_PLATFORM := Rockchip
#CONFIG_BCMDHD_PLATFORM := Dummy
...
ifeq ($(CONFIG_BCMDHD_PLATFORM),Rockchip)
DHDCFLAGS += -DCONFIG_DHD_PLAT_ROCKCHIP
CONFIG_DHD_OF_SUPPORT = y
DHDCFLAGS += -DDHD_CUSTOM_PLAT_DATA
DHDOFILES += dhd_custom_rockchip.o
else ifeq ($(CONFIG_BCMDHD_PLATFORM),Dummy)
DHDCFLAGS += -DCONFIG_DHD_PLAT_DUMMY
CONFIG_DHD_OF_SUPPORT = y
DHDCFLAGS += -DDHD_CUSTOM_PLAT_DATA
...
ifneq ($(shell expr $(CONFIG_ANDROID_VERSION) \>= 13), 1)
...
# Reverted, move back to Android specific area
...
# Reverted, move WL_SELF_MANAGED_REGDOM back to here
 DHDCFLAGS += -DWL_SELF_MANAGED_REGDOM
...
# tput enhancement
ifeq ($(CONFIG_BCMDHD_BROKEN_SG),y)
  DHDCFLAGS += -DSDPCM_TXGLOM_CPY_EXT
