...
#define pcie_default_state	bcm_pcie_default_state2
#else
/* declare and export bcm_pcie_default_state in drivers/pci/pci.c */
extern struct pci_saved_state *bcm_pcie_default_state;
#define pcie_default_state	bcm_pcie_default_state
#endif /* BCMDHDX && WL_DHD_XR_CLIENT */
...
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(3, 0, 0) */
#endif /* EXYNOS_PCIE_MODULE_PATCH */
...
dhdpcie_irq_disabled(dhd_bus_t *bus)
{
	...
	!defined(CONFIG_KVM_BOOK3S_64_HV_MODULE)
