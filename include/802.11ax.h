...
/* AID range is 1 to 2007 for infra BSS.
 * The AID field for a non-DMG and non-S1G STA is in the range of 1 to 2007.
 * This value is placed in the 14 LSBs of the AID field, with the two MSBs
 * of the AID field set to 1. The AID field for an S1G STA is in the range
 * of 1 to 8191, and the 3 MSBs of the AID field are reserved.
 */
#define HE_AID12_INVALID		2008
