...
#define CYW43022_D11N_ID        0xA80E          /* 43022 802.11n dualband device */
#define CYW43023_D11N_ID        0xA80F          /* 43023 802.11n dualband device */
...
#define BCM43012_CHIP(chipid)	((CHIPID(chipid) == BCM43012_CHIP_ID) || \
				(CHIPID(chipid) == CYW43022_CHIP_ID) || \
				(CHIPID(chipid) == CYW43023_CHIP_ID))
